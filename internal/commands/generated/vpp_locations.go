...
func NewVppLocationsCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "vpp-locations",
...
func newVppLocationsListCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamfpro-cli vpp-locations list

  # List vpp-locations and extract IDs
  jamfpro-cli vpp-locations list --field id`,
...
func newVppLocationsGetCmd(ctx *CLIContext) *cobra.Command {
	var ()
  ...
  jamfpro-cli vpp-locations get 1

  # Get a vpp-location and output as YAML
  jamfpro-cli vpp-locations get 1 -o yaml`,
...
func newVppLocationsCreateCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  jamfpro-cli vpp-locations create --scaffold

  # Create a vpp-location from JSON
  echo '{"name":"Example"}' | jamfpro-cli vpp-locations create

  # Get a vpp-location, modify it, and create a copy
  jamfpro-cli vpp-locations get 1 -o json | jq '.name = "Copy"' | jamfpro-cli vpp-locations create`,
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := context.Background()
...
func newVppLocationsDeleteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagYes    bool
		flagDryRun bool
	)
  ...
  jamfpro-cli vpp-locations delete 1

  # Delete without confirmation prompt
  jamfpro-cli vpp-locations delete 1 --yes`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := context.Background()
...
func newVppLocationsHistoryCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamfpro-cli vpp-locations history 1`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := context.Background()
...
func newVppLocationsAddHistoryNoteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
...
func newVppLocationsPatchCmd(ctx *CLIContext) *cobra.Command {
	var ()
...
func newVppLocationsReclaimCmd(ctx *CLIContext) *cobra.Command {
	var ()
...
func newVppLocationsRevokeLicensesCmd(ctx *CLIContext) *cobra.Command {
	var ()
