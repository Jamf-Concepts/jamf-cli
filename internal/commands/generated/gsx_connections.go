...
func NewGsxConnectionsCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "gsx-connections",
...
func newGsxConnectionsListCmd(ctx *CLIContext) *cobra.Command {
	var ()
...
func newGsxConnectionsUpdateCmd(ctx *CLIContext) *cobra.Command {
	var ()
...
func newGsxConnectionsHistoryCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
...
func newGsxConnectionsAddHistoryNoteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
...
func newGsxConnectionsPatchCmd(ctx *CLIContext) *cobra.Command {
	var ()
...
func newGsxConnectionsTestCmd(ctx *CLIContext) *cobra.Command {
	var ()
