...
func NewClassicMacosConfigProfilesCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
...
func newClassicMacosConfigProfilesListCmd(ctx *CLIContext) *cobra.Command {
...
func newClassicMacosConfigProfilesGetByNameCmd(ctx *CLIContext) *cobra.Command {
	return &cobra.Command{
