...
func NewMacOsManagedSoftwareUpdatesCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
...
func newMacOsManagedSoftwareUpdatesListCmd(ctx *CLIContext) *cobra.Command {
	var ()
  ...
  jamfpro-cli mac-os-managed-software-updates list
...
func newMacOsManagedSoftwareUpdatesSendUpdatesCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
