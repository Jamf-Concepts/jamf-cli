...
func NewPackagesCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "packages",
...
func newPackagesListCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
...
func newPackagesGetCmd(ctx *CLIContext) *cobra.Command {
	var ()
...
func newPackagesCreateCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  jamfpro-cli packages create --scaffold

  # Create a package from JSON
  echo '{"name":"Example"}' | jamfpro-cli packages create
...
func newPackagesUpdateCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  echo '{"name":"Updated"}' | jamfpro-cli packages update 1
...
func newPackagesDeleteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagYes    bool
		flagDryRun bool
	)
...
func newPackagesDeleteMultipleCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagYes      bool
		flagDryRun   bool
		flagIds      []string
...
func newPackagesHistoryCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
...
func newPackagesAddHistoryNoteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
...
func newPackagesExportCmd(ctx *CLIContext) *cobra.Command {
	var (
...
func newPackagesHistoryExportCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagExportFields []string
		flagExportLabels []string
		flagPage         int
...
func newPackagesUploadCmd(ctx *CLIContext) *cobra.Command {
	var ()
