...
func NewGroupsCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "groups",
		Short: "Manage groups",
...
func newGroupsListCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamfpro-cli groups list

  # List groups and extract IDs
  jamfpro-cli groups list --field id`,
...
func newGroupsGetCmd(ctx *CLIContext) *cobra.Command {
	var ()
  ...
  jamfpro-cli groups get 1

  # Get a group and output as YAML
  jamfpro-cli groups get 1 -o yaml`,
...
func newGroupsDeleteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagYes    bool
		flagDryRun bool
	)
  ...
  jamfpro-cli groups delete 1

  # Delete without confirmation prompt
  jamfpro-cli groups delete 1 --yes`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newGroupsPatchCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
