...
func NewPatchPolicyV2SCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
...
func newPatchPolicyV2SListCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamfpro-cli patch-policy-v-2s list
...
func newPatchPolicyV2SGetCmd(ctx *CLIContext) *cobra.Command {
	var ()
  ...
  jamfpro-cli patch-policy-v-2s get 1
...
func newPatchPolicyV2SDeleteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagYes    bool
		flagDryRun bool
	)
  ...
  jamfpro-cli patch-policy-v-2s delete 1
...
func newPatchPolicyV2SDashboardCmd(ctx *CLIContext) *cobra.Command {
	var ()
