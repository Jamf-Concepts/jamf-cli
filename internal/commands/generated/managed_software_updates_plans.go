...
func NewManagedSoftwareUpdatesPlansCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
...
func newManagedSoftwareUpdatesPlansListCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamfpro-cli managed-software-updates-plans list
...
func newManagedSoftwareUpdatesPlansGetCmd(ctx *CLIContext) *cobra.Command {
	var (
  ...
  jamfpro-cli managed-software-updates-plans get 1
...
func newManagedSoftwareUpdatesPlansCreateCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  jamfpro-cli managed-software-updates-plans create --scaffold

  # Create a managed-software-updates-plan from JSON
  echo '{"name":"Example"}' | jamfpro-cli managed-software-updates-plans create
...
func newManagedSoftwareUpdatesPlansUpdateCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  echo '{"name":"Updated"}' | jamfpro-cli managed-software-updates-plans update 1
...
func newManagedSoftwareUpdatesPlansAbandonCmd(ctx *CLIContext) *cobra.Command {
	var ()
