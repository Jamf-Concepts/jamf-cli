...
func NewPatchPolicyLogsV2SCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
...
func newPatchPolicyLogsV2SGetCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamfpro-cli patch-policy-logs-v-2s get 1
...
func newPatchPolicyLogsV2SRetryCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
...
func newPatchPolicyLogsV2SRetryAllCmd(ctx *CLIContext) *cobra.Command {
	var ()
