...
func newParentAppsListCmd(ctx *CLIContext) *cobra.Command {
  ...
  jamfpro-cli parent-apps list

  # List parent-apps and extract IDs
  jamfpro-cli parent-apps list --field id`,
...
func newParentAppsUpdateCmd(ctx *CLIContext) *cobra.Command {
  ...
  echo '{"name":"Updated"}' | jamfpro-cli parent-apps update 1

  # Get a parent-app, modify, and update
  jamfpro-cli parent-apps get 1 -o json | jq '.name = "New Name"' | jamfpro-cli parent-apps update 1`,
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newParentAppsHistoryCmd(ctx *CLIContext) *cobra.Command {
  ...
  jamfpro-cli parent-apps history 1`,
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
