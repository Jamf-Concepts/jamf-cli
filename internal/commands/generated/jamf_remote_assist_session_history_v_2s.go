...
func NewJamfRemoteAssistSessionHistoryV2SCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
...
func newJamfRemoteAssistSessionHistoryV2SListCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamfpro-cli jamf-remote-assist-session-history-v-2s list

  # List jamf-remote-assist-session-history-v-2s and extract IDs
  jamfpro-cli jamf-remote-assist-session-history-v-2s list --field id`,
...
func newJamfRemoteAssistSessionHistoryV2SGetCmd(ctx *CLIContext) *cobra.Command {
	var ()
  ...
  jamfpro-cli jamf-remote-assist-session-history-v-2s get 1

  # Get a jamf-remote-assist-session-history-v-2 and output as YAML
  jamfpro-cli jamf-remote-assist-session-history-v-2s get 1 -o yaml`,
...
func newJamfRemoteAssistSessionHistoryV2SExportCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  jamfpro-cli jamf-remote-assist-session-history-v-2s export --out-file jamf-remote-assist-session-history-v-2s.csv`,
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
