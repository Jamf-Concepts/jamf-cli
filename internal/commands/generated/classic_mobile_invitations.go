...
func newClassicMobileInvitationsCreateCmd(ctx *CLIContext) *cobra.Command {
  ...
  echo '{"name":"Example"}' | jamf-cli classic-mobile-invitations create

  # Get a mobile_device_invitation, modify, and create a copy
  jamf-cli classic-mobile-invitations get 1 -o json | jq '.name = "Copy"' | jamf-cli classic-mobile-invitations create`,
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
