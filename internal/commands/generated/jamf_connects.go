...
func NewJamfConnectsCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "jamf-connects",
...
func newJamfConnectsListCmd(ctx *CLIContext) *cobra.Command {
	var ()
  ...
  jamfpro-cli jamf-connects list
...
func newJamfConnectsUpdateCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  echo '{"name":"Updated"}' | jamfpro-cli jamf-connects update 1
...
func newJamfConnectsHistoryCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
...
func newJamfConnectsAddHistoryNoteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
