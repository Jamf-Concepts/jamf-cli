...
func NewStaticComputerGroupsCmd(ctx *CLIContext) *cobra.Command {
	cmd := &cobra.Command{
...
func newStaticComputerGroupsListCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamfpro-cli static-computer-groups list

  # List static-computer-groups and extract IDs
  jamfpro-cli static-computer-groups list --field id`,
...
func newStaticComputerGroupsGetCmd(ctx *CLIContext) *cobra.Command {
	var ()
  ...
  jamfpro-cli static-computer-groups get 1

  # Get a static-computer-group and output as YAML
  jamfpro-cli static-computer-groups get 1 -o yaml`,
...
func newStaticComputerGroupsCreateCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagPlatform bool
		flagScaffold bool
	)
  ...
  jamfpro-cli static-computer-groups create --scaffold

  # Create a static-computer-group from JSON
  echo '{"name":"Example"}' | jamfpro-cli static-computer-groups create

  # Get a static-computer-group, modify it, and create a copy
  jamfpro-cli static-computer-groups get 1 -o json | jq '.name = "Copy"' | jamfpro-cli static-computer-groups create`,
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newStaticComputerGroupsUpdateCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  echo '{"name":"Updated"}' | jamfpro-cli static-computer-groups update 1

  # Get a static-computer-group, modify, and update
  jamfpro-cli static-computer-groups get 1 -o json | jq '.name = "New Name"' | jamfpro-cli static-computer-groups update 1`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newStaticComputerGroupsDeleteCmd(ctx *CLIContext) *cobra.Command {
	var (
		flagYes    bool
		flagDryRun bool
	)
  ...
  jamfpro-cli static-computer-groups delete 1

  # Delete without confirmation prompt
  jamfpro-cli static-computer-groups delete 1 --yes`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
