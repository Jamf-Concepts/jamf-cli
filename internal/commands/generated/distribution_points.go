...
func newDistributionPointsListCmd(ctx *CLIContext) *cobra.Command {
  ...
  jamfpro-cli distribution-points list
...
func newDistributionPointsGetCmd(ctx *CLIContext) *cobra.Command {
  ...
  jamfpro-cli distribution-points get 1
...
func newDistributionPointsCreateCmd(ctx *CLIContext) *cobra.Command {
  ...
  jamfpro-cli distribution-points create --scaffold

  # Create a distribution-point from JSON
  echo '{"name":"Example"}' | jamfpro-cli distribution-points create
...
func newDistributionPointsUpdateCmd(ctx *CLIContext) *cobra.Command {
  ...
  echo '{"name":"Updated"}' | jamfpro-cli distribution-points update 1
...
func newDistributionPointsDeleteCmd(ctx *CLIContext) *cobra.Command {
  ...
  jamfpro-cli distribution-points delete 1
