...
func newMobileDevicePrestagesListCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro mobile-device-prestages list --field id`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			vft := newVersionFallback("/v3/mobile-device-prestages")
			...
			if flagAll && flagPage == 0 {
				...
				for {
					...
					resp, err := vft.do(ctx.Client, reqCtx, "GET", pagePath, nil, []string{"/v2/mobile-device-prestages"})
					if err != nil {
						return err
					}
			...
			// Make request
			resp, err := vft.do(ctx.Client, reqCtx, "GET", path, nil, []string{"/v2/mobile-device-prestages"})
			if err != nil {
				return err
			}
...
func newMobileDevicePrestagesGetCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro mobile-device-prestages get 1 -o yaml`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			vft := newVersionFallback("/v3/mobile-device-prestages/{id}")

			// Make request
			resp, err := vft.do(ctx.Client, reqCtx, "GET", path, nil, []string{"/v2/mobile-device-prestages/{id}"})
			if err != nil {
				return err
			}
			defer resp.Body.Close()
...
func newMobileDevicePrestagesUpdateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  "versionLock": 0
			...
			if len(flagSet) > 0 {
				...
				setDoc, serr := buildMergePatchFromSet(flagSet, map[string]string{"allowPairing": "boolean", "anchorCertificates": "array", "authenticationPrompt": "string", "autoAdvanceSetup": "boolean", "configureDeviceBeforeSetupAssistant": "boolean", "defaultPrestage": "boolean", "department": "string", "deviceEnrollmentProgramInstanceId": "string", "displayName": "string", "doNotUseProfileFromBackup": "boolean", "enableDeviceBasedActivationLock": "boolean", "enforceTemporarySessionTimeout": "boolean", "enforceUserSessionTimeout": "boolean", "enrollmentCustomizationId": "string", "enrollmentSiteId": "string", "installAppsDuringEnrollment": "boolean", "keepExistingLocationInformation": "boolean", "keepExistingSiteMembership": "boolean", "language": "string", "locationInformation": "object", "locationInformation.buildingId": "string", "locationInformation.departmentId": "string", "locationInformation.email": "string", "locationInformation.id": "string", "locationInformation.phone": "string", "locationInformation.position": "string", "locationInformation.realname": "string", "locationInformation.room": "string", "locationInformation.username": "string", "locationInformation.versionLock": "integer", "mandatory": "boolean", "maximumSharedAccounts": "integer", "mdmRemovable": "boolean", "minimumOsSpecificVersionIos": "string", "minimumOsSpecificVersionIpad": "string", "multiUser": "boolean", "names": "object", "names.assignNamesUsing": "string", "names.deviceNamePrefix": "string", "names.deviceNameSuffix": "string", "names.deviceNamingConfigured": "boolean", "names.manageNames": "boolean", "names.prestageDeviceNames": "array", "names.singleDeviceName": "string", "preserveManagedApps": "boolean", "prestageMinimumOsTargetVersionTypeIos": "string", "prestageMinimumOsTargetVersionTypeIpad": "string", "preventActivationLock": "boolean", "purchasingInformation": "object", "purchasingInformation.appleCareId": "string", "purchasingInformation.id": "string", "purchasingInformation.leaseDate": "string", "purchasingInformation.leased": "boolean", "purchasingInformation.lifeExpectancy": "integer", "purchasingInformation.poDate": "string", "purchasingInformation.poNumber": "string", "purchasingInformation.purchasePrice": "string", "purchasingInformation.purchased": "boolean", "purchasingInformation.purchasingAccount": "string", "purchasingInformation.purchasingContact": "string", "purchasingInformation.vendor": "string", "purchasingInformation.versionLock": "integer", "purchasingInformation.warrantyDate": "string", "region": "string", "requireAuthentication": "boolean", "rtsConfigProfileId": "string", "rtsEnabled": "boolean", "sendTimezone": "boolean", "skipSetupItems": "object", "storageQuotaSizeMegabytes": "integer", "supervised": "boolean", "supportEmailAddress": "string", "supportPhoneNumber": "string", "temporarySessionOnly": "boolean", "temporarySessionTimeout": "integer", "timezone": "string", "useStorageQuotaSize": "boolean", "userSessionTimeout": "integer", "versionLock": "integer"})
				if serr != nil {
					return serr
				}
...
func newMobileDevicePrestagesDeleteCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro mobile-device-prestages delete 1 --yes`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Make request
			resp, err := vft.do(ctx.Client, reqCtx, "DELETE", path, nil, []string{"/v2/mobile-device-prestages/{id}"})
			if err != nil {
				return err
			}
			defer resp.Body.Close()
...
func newMobileDevicePrestagesHistoryCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro mobile-device-prestages history --name "Example"`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			vft := newVersionFallback("/v3/mobile-device-prestages/{id}/history")
			...
			if flagAll && flagPage == 0 {
				...
				for {
					...
					resp, err := vft.do(ctx.Client, reqCtx, "GET", pagePath, nil, []string{"/v2/mobile-device-prestages/{id}/history"})
					if err != nil {
						return err
					}
			...
			// Make request
			resp, err := vft.do(ctx.Client, reqCtx, "GET", path, nil, []string{"/v2/mobile-device-prestages/{id}/history"})
			if err != nil {
				return err
			}
			defer resp.Body.Close()
...
func newMobileDevicePrestagesAttachmentsCmd(ctx *registry.CLIContext) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			vft := newVersionFallback("/v3/mobile-device-prestages/{id}/attachments")

			// Make request
			resp, err := vft.do(ctx.Client, reqCtx, "GET", path, nil, []string{"/v2/mobile-device-prestages/{id}/attachments"})
			if err != nil {
				return err
			}
			defer resp.Body.Close()
...
func newMobileDevicePrestagesScopeCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
...
func newMobileDevicePrestagesScopeByIdCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagName string
	)
...
func newMobileDevicePrestagesSyncsByIdCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagName string
	)
...
func newMobileDevicePrestagesLatestCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagName string
	)
