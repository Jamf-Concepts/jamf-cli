...
func newJamfConnectDeploymentTasksCreateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  echo '{"name":"Example"}' | jamf-cli pro jamf-connect-deployment-tasks create 1

  # Get a jamf-connect-deployment-task, modify it, and create a copy
  jamf-cli pro jamf-connect-deployment-tasks get 1 -o json | jq '.name = "Copy"' | jamf-cli pro jamf-connect-deployment-tasks create 1`,
