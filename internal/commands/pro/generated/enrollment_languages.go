...
func newEnrollmentLanguagesUpdateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  "username": "admin"
			...
			if len(flagSet) > 0 {
				...
				setDoc, serr := buildMergePatchFromSet(flagSet, map[string]string{"certificateButton": "string", "certificateProfileDescription": "string", "certificateProfileName": "string", "certificateText": "string", "checkEnrollmentMessage": "string", "checkNowButton": "string", "completeMessage": "string", "deviceClassButton": "string", "deviceClassDescription": "string", "deviceClassEnterprise": "string", "deviceClassEnterpriseDescription": "string", "deviceClassPersonal": "string", "deviceClassPersonalDescription": "string", "enterpriseButton": "string", "enterpriseEula": "string", "enterprisePending": "string", "enterpriseProfileDescription": "string", "enterpriseProfileName": "string", "enterpriseText": "string", "eulaButton": "string", "failedMessage": "string", "languageCode": "string", "loginButton": "string", "loginDescription": "string", "logoutButton": "string", "name": "string", "password": "string", "personalEula": "string", "quickAddButton": "string", "quickAddName": "string", "quickAddPending": "string", "quickAddText": "string", "siteDescription": "string", "title": "string", "tryAgainButton": "string", "userEnrollmentButton": "string", "userEnrollmentProfileDescription": "string", "userEnrollmentProfileName": "string", "userEnrollmentText": "string", "username": "string"})
				if serr != nil {
					return serr
				}
...
func newEnrollmentLanguagesDeleteMultipleCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  "ids": []
			...
			if flagDryRun {
				fmt.Fprintf(os.Stderr, "Would run \"delete-multiple\" on this enrollment-language\n")
				return nil
			}
			if !flagYes {
				noInput, _ := cmd.Flags().GetBool("no-input")
				...
				fmt.Fprintf(os.Stderr, "⚠️  This will run \"delete-multiple\" on this enrollment-language. Type 'yes' to confirm: ")
				var confirm string
				fmt.Scanln(&confirm)
				if confirm != "yes" {
					return fmt.Errorf("aborted")
