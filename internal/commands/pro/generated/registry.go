...
func RegisterCommands(root *cobra.Command, ctx *registry.CLIContext) {
	...
	root.AddCommand(NewBrandingImagesCmd(ctx))
	...
	root.AddCommand(NewCheckInCmd(ctx))
	...
	root.AddCommand(NewDdmClientsCmd(ctx))
	...
	root.AddCommand(NewEnrollmentCustomizationsImagesCmd(ctx))
	...
	root.AddCommand(NewJamfRemoteAssistSessionCmd(ctx))
	root.AddCommand(NewJcdsCmd(ctx))
	root.AddCommand(NewJcdsFilesCmd(ctx))
	root.AddCommand(NewLastLoginCmd(ctx))
	root.AddCommand(NewLdapLookupsCmd(ctx))
	...
	root.AddCommand(NewOauth2Cmd(ctx))
	...
	root.AddCommand(NewPatchManagementAcceptDisclaimerCmd(ctx))
	root.AddCommand(NewPatchPoliciesCmd(ctx))
	root.AddCommand(NewPatchSoftwareTitleConfigurationsCmd(ctx))
	root.AddCommand(NewPkiAdcsSettingsCmd(ctx))
	root.AddCommand(NewPkiDigicertCmd(ctx))
	root.AddCommand(NewPkiVenafiCmd(ctx))
	...
	root.AddCommand(NewSystemCmd(ctx))
	...
	root.AddCommand(NewUserCmd(ctx))
