...
func RegisterCommands(root *cobra.Command, ctx *registry.CLIContext) {
	...
	root.AddCommand(NewAccountsCmd(ctx))
	root.AddCommand(NewActivationCodeCmd(ctx))
	...
	root.AddCommand(NewApiAuthenticationCmd(ctx))
	root.AddCommand(NewApiIntegrationsCmd(ctx))
	root.AddCommand(NewApiRolePrivilegesCmd(ctx))
	root.AddCommand(NewApiRolesCmd(ctx))
	root.AddCommand(NewApnsClientPushStatusCmd(ctx))
	root.AddCommand(NewAppInstallersCmd(ctx))
	root.AddCommand(NewAppInstallersDeploymentsCmd(ctx))
	root.AddCommand(NewAppInstallersTitlesCmd(ctx))
	root.AddCommand(NewAppRequestCmd(ctx))
	root.AddCommand(NewAppRequestFormInputFieldsCmd(ctx))
	root.AddCommand(NewAppStoreCountryCodesCmd(ctx))
	root.AddCommand(NewBrandingCmd(ctx))
	root.AddCommand(NewBuildingsCmd(ctx))
	root.AddCommand(NewCacheSettingsCmd(ctx))
	root.AddCommand(NewCategoriesCmd(ctx))
	root.AddCommand(NewCertificateAuthorityCmd(ctx))
	root.AddCommand(NewClassicLdapCmd(ctx))
	root.AddCommand(NewClientCheckInCmd(ctx))
	root.AddCommand(NewCloudAzureCmd(ctx))
	root.AddCommand(NewCloudDistributionPointCmd(ctx))
	root.AddCommand(NewCloudIdpCmd(ctx))
	root.AddCommand(NewCloudInformationCmd(ctx))
	root.AddCommand(NewCloudLdapCmd(ctx))
	root.AddCommand(NewComputerExtensionAttributesCmd(ctx))
	root.AddCommand(NewComputerExtensionAttributesTemplatesCmd(ctx))
	...
	root.AddCommand(NewComputerInventoryCmd(ctx))
	root.AddCommand(NewComputerInventoryCollectionSettingsCmd(ctx))
	root.AddCommand(NewComputerInventoryCollectionSettingsCustomPathCmd(ctx))
	root.AddCommand(NewComputerPrestagesCmd(ctx))
	root.AddCommand(NewConditionalAccessCmd(ctx))
	root.AddCommand(NewCsaCmd(ctx))
	root.AddCommand(NewDashboardCmd(ctx))
	root.AddCommand(NewDeclarativeDeviceManagementCmd(ctx))
	root.AddCommand(NewDepartmentsCmd(ctx))
	root.AddCommand(NewDeviceCommunicationSettingsCmd(ctx))
	root.AddCommand(NewDeviceEnrollmentsCmd(ctx))
	root.AddCommand(NewDigicertCmd(ctx))
	root.AddCommand(NewDistributionPointCmd(ctx))
	root.AddCommand(NewDockItemsCmd(ctx))
	root.AddCommand(NewEbooksCmd(ctx))
	root.AddCommand(NewEnrollmentCmd(ctx))
	root.AddCommand(NewEnrollmentAccessGroupsCmd(ctx))
	root.AddCommand(NewEnrollmentCustomizationCmd(ctx))
	root.AddCommand(NewEnrollmentCustomizationImagesCmd(ctx))
	...
	root.AddCommand(NewHealthCheckCmd(ctx))
	root.AddCommand(NewIconCmd(ctx))
	root.AddCommand(NewImpactAlertNotificationSettingsCmd(ctx))
	root.AddCommand(NewInventoryInformationCmd(ctx))
	root.AddCommand(NewInventoryPreloadCmd(ctx))
	root.AddCommand(NewInventoryPreloadRecordsCmd(ctx))
	root.AddCommand(NewJamfCloudDistributionServiceCmd(ctx))
	root.AddCommand(NewJamfCloudDistributionServiceFilesCmd(ctx))
	root.AddCommand(NewJamfConnectCmd(ctx))
	root.AddCommand(NewJamfConnectConfigProfilesCmd(ctx))
	root.AddCommand(NewJamfManagementFrameworkCmd(ctx))
	root.AddCommand(NewJamfPackageCmd(ctx))
	root.AddCommand(NewJamfProAccountPreferencesCmd(ctx))
	root.AddCommand(NewJamfProInformationCmd(ctx))
	root.AddCommand(NewJamfProInitializationCmd(ctx))
	root.AddCommand(NewJamfProNotificationsCmd(ctx))
	root.AddCommand(NewJamfProServerUrlCmd(ctx))
	root.AddCommand(NewJamfProUserAccountSettingsCmd(ctx))
	root.AddCommand(NewJamfProVersionCmd(ctx))
	root.AddCommand(NewJamfProtectCmd(ctx))
	root.AddCommand(NewJamfRemoteAssistCmd(ctx))
	root.AddCommand(NewLastLoginCmd(ctx))
	root.AddCommand(NewLdapCmd(ctx))
	root.AddCommand(NewLocalAdminPasswordCmd(ctx))
	root.AddCommand(NewLocalesCmd(ctx))
	root.AddCommand(NewLogFlushingCmd(ctx))
	root.AddCommand(NewLogFlushingTaskCmd(ctx))
	...
	root.AddCommand(NewManagedSoftwareUpdatesPlansGroupCmd(ctx))
	root.AddCommand(NewMdmCmd(ctx))
	root.AddCommand(NewMdmRenewalCmd(ctx))
	root.AddCommand(NewMdmRenewalDeviceCommonDetailsCmd(ctx))
	root.AddCommand(NewMobileDeviceAppsCmd(ctx))
	root.AddCommand(NewMobileDeviceEnrollmentProfileCmd(ctx))
	...
	root.AddCommand(NewOidcCmd(ctx))
	root.AddCommand(NewOnboardingCmd(ctx))
	root.AddCommand(NewPackagesCmd(ctx))
	root.AddCommand(NewParentAppCmd(ctx))
	root.AddCommand(NewPatchManagementCmd(ctx))
	...
	root.AddCommand(NewReturnToServiceCmd(ctx))
	root.AddCommand(NewSchedulerCmd(ctx))
	root.AddCommand(NewSchedulerJobsCmd(ctx))
	root.AddCommand(NewScriptsCmd(ctx))
	root.AddCommand(NewSelfServiceCmd(ctx))
	...
	root.AddCommand(NewServiceDiscoveryEnrollmentCmd(ctx))
	root.AddCommand(NewSitesCmd(ctx))
	root.AddCommand(NewSlasaCmd(ctx))
	root.AddCommand(NewSmartUserGroupsCmd(ctx))
	root.AddCommand(NewSmtpServerCmd(ctx))
	root.AddCommand(NewSsoOauthSessionTokensCmd(ctx))
	...
	root.AddCommand(NewTeacherAppCmd(ctx))
	root.AddCommand(NewTeamViewerRemoteAdministrationCmd(ctx))
	root.AddCommand(NewTimeZonesCmd(ctx))
	root.AddCommand(NewUserSessionsCmd(ctx))
	root.AddCommand(NewVenafiCmd(ctx))
	root.AddCommand(NewVolumePurchasingLocationsCmd(ctx))
