...
// NewCloudAzureCmd creates the cloud-azure command group
func NewCloudAzureCmd(ctx *registry.CLIContext) *cobra.Command {
	cmd := &cobra.Command{
		Use:         "cloud-azure",
		Short:       "Manage cloud-azure",
		Long:        `Manage cloud-azure in Jamf Pro.`,
		Annotations: map[string]string{"jamf:api": "pro"},
	}

	cmd.AddCommand(newCloudAzureGetCmd(ctx))
	cmd.AddCommand(newCloudAzureCreateCmd(ctx))
	cmd.AddCommand(newCloudAzureUpdateCmd(ctx))
	cmd.AddCommand(newCloudAzureDeleteCmd(ctx))
	cmd.AddCommand(newCloudAzureMappingsCmd(ctx))
	cmd.AddCommand(newCloudAzureServerConfigurationCmd(ctx))

	return cmd
}

func newCloudAzureGetCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
  ...
  jamf-cli pro cloud-azure get 1

  # Get a cloud-azure and output as YAML
  jamf-cli pro cloud-azure get 1 -o yaml`,
...
func newCloudAzureCreateCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
  ...
  jamf-cli pro cloud-azure create --scaffold
...
func newCloudAzureUpdateCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagScaffold bool
		flagSet      []string
	)
  ...
  jamf-cli pro cloud-azure update 1 --set field=value
...
func newCloudAzureDeleteCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagYes    bool
		flagDryRun bool
	)
  ...
  jamf-cli pro cloud-azure delete 1

  # Delete without confirmation prompt
  jamf-cli pro cloud-azure delete 1 --yes`,
...
func newCloudAzureMappingsCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
...
func newCloudAzureServerConfigurationCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
