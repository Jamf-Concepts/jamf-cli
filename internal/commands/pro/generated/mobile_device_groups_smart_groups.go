...
func NewMobileDeviceGroupsSmartGroupsCmd(ctx *registry.CLIContext) *cobra.Command {
	...
	cmd.AddCommand(newMobileDeviceGroupsSmartGroupsGetByNameCmd(ctx))
	cmd.AddCommand(newMobileDeviceGroupsSmartGroupsApplyCmd(ctx))
	cmd.AddCommand(newMobileDeviceGroupsSmartGroupsDeleteByNameCmd(ctx))
...
func newMobileDeviceGroupsSmartGroupsGetCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli mobile-device-groups-smart-groups get-by-name "Example"
...
func newMobileDeviceGroupsSmartGroupsGetByNameCmd(ctx *registry.CLIContext) *cobra.Command {
	return &cobra.Command{
		Use:   "get-by-name <name>",
		Short: "Get a mobile-device-groups-smart-groups by name",
		Example: `  # Get a mobile-device-groups-smart-groups by name
  jamf-cli mobile-device-groups-smart-groups get-by-name "Example"

  # Get by name and output as YAML
  jamf-cli mobile-device-groups-smart-groups get-by-name "Example" -o yaml`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newMobileDeviceGroupsSmartGroupsDeleteByNameCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagYes    bool
		flagDryRun bool
	)
	...
	cmd := &cobra.Command{
		...
		Short: "Delete a mobile-device-groups-smart-groups by name",
		Example: `  # Delete a mobile-device-groups-smart-groups by name (with confirmation)
  jamf-cli mobile-device-groups-smart-groups delete-by-name "Example"

  # Delete without confirmation prompt
  jamf-cli mobile-device-groups-smart-groups delete-by-name "Example" --yes`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
			name := args[0]
			...
			if id == "" {
				return fmt.Errorf("no mobile-device-groups-smart-groups found with displayName %q", name)
			}
			...
			if !flagYes {
				...
				fmt.Fprintf(os.Stderr, "This will delete mobile-device-groups-smart-groups %q (id: %s). Type 'yes' to confirm: ", name, id)
				var confirm string
				fmt.Scanln(&confirm)
				if confirm != "yes" {
					return fmt.Errorf("aborted")
