...
func newCategoriesListCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro categories list --field id`,
		Annotations: map[string]string{"jamf:privileges": "Read Categories,Read Self Service", "jamf:api": "pro", "jamf:gateway-privileges": "categories:read,self-service:read"},
...
func newCategoriesGetCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro categories get 1 -o yaml`,
		Annotations: map[string]string{"jamf:privileges": "Read Categories", "jamf:api": "pro", "jamf:gateway-privileges": "categories:read"},
...
func newCategoriesCreateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro categories get 1 -o json | jq '.name = "Copy"' | jamf-cli pro categories create`,
		Annotations: map[string]string{"jamf:privileges": "Create Categories", "jamf:api": "pro", "jamf:gateway-privileges": "categories:create"},
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newCategoriesUpdateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro categories get 1 -o json | jq '.name = "New Name"' | jamf-cli pro categories update 1`,
		Annotations: map[string]string{"jamf:privileges": "Update Categories", "jamf:api": "pro", "jamf:gateway-privileges": "categories:update"},
		Args:        cobra.MaximumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newCategoriesDeleteCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro categories delete 1 --yes`,
		Annotations: map[string]string{"jamf:destructive": "true", "jamf:privileges": "Delete Categories", "jamf:api": "pro", "jamf:gateway-privileges": "categories:delete"},
		Args:        cobra.MaximumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newCategoriesDeleteMultipleCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  "ids": []
			...
			if flagDryRun {
				fmt.Fprintf(os.Stderr, "Would run \"delete-multiple\" on this category\n")
				return nil
			}
			if !flagYes {
				noInput, _ := cmd.Flags().GetBool("no-input")
				...
				fmt.Fprintf(os.Stderr, "⚠️  This will run \"delete-multiple\" on this category. Type 'yes' to confirm: ")
				var confirm string
				fmt.Scanln(&confirm)
				if confirm != "yes" {
					return fmt.Errorf("aborted")
...
func newCategoriesApplyCmd(ctx *registry.CLIContext) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Annotations: map[string]string{"jamf:api": "pro", "jamf:gateway-privileges": "categories:create,categories:read,categories:update,self-service:read"},
