...
// NewOidcCmd creates the oidc command group
func NewOidcCmd(ctx *registry.CLIContext) *cobra.Command {
	cmd := &cobra.Command{
		Use:         "oidc",
		Short:       "Manage oidc",
		Long:        `Manage oidc in Jamf Pro.`,
		Annotations: map[string]string{"jamf:api": "pro"},
	}

	cmd.AddCommand(newOidcDirectIdpLoginUrlCmd(ctx))
	cmd.AddCommand(newOidcDispatchCmd(ctx))
	cmd.AddCommand(newOidcGenerateCertificateCmd(ctx))
	cmd.AddCommand(newOidcPublicFeaturesCmd(ctx))
	cmd.AddCommand(newOidcPublicKeyCmd(ctx))

	return cmd
}

func newOidcDirectIdpLoginUrlCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
...
func newOidcDispatchCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagScaffold bool
	)
...
func newOidcGenerateCertificateCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
...
func newOidcPublicFeaturesCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
...
func newOidcPublicKeyCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
