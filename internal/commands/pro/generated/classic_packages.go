			...
			if fromFile != "" {
				...
				for _, entry := range entries {
					if isNumericID(entry) {
						...
						if resolvedID == "" {
							id, err := resolveClassicNameToIDForApply(reqCtx, ctx.Client, "packages", "packages", entry, noInputBulk)
							if err != nil {
				...
				if !flagYes {
					...
					fmt.Fprintf(os.Stderr, "This will delete %d packages. Type 'yes' to confirm: ", len(bulk))
					var confirm string
					fmt.Scanln(&confirm)
					if confirm != "yes" {
