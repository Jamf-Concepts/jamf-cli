...
func newClassicDirectoryBindingsCreateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  echo '{"name":"Example"}' | jamf-cli classic-directory-bindings create

  # Get a directory_binding, modify, and create a copy
  jamf-cli classic-directory-bindings get 1 -o json | jq '.name = "Copy"' | jamf-cli classic-directory-bindings create`,
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newClassicDirectoryBindingsUpdateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  echo '{"name":"Updated"}' | jamf-cli classic-directory-bindings update 1

  # Get, modify, and update a directory_binding
  jamf-cli classic-directory-bindings get 1 -o json | jq '.name = "New"' | jamf-cli classic-directory-bindings update 1`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
