...
func newOnboardingsListCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
	...
	cmd := &cobra.Command{
		...
		Example: `  # List all onboardings
  jamf-cli onboardings list

  # List onboardings and extract IDs
  jamf-cli onboardings list --field id`,
