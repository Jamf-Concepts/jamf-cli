...
func newSmtpServerUpdateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro smtp-server update --from-file smtp-server.json`,
		Annotations: map[string]string{"jamf:privileges": "Update SMTP Server", "jamf:api": "pro", "jamf:gateway-privileges": "smtp-server:update"},
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
  ...
  "senderSettings": {
    ...
    "emailAddress": "exampleEmail@example.com"
			...
			if len(flagSet) > 0 {
				...
				setDoc, serr := buildMergePatchFromSet(flagSet, map[string]string{"authenticationType": "string", "basicAuthCredentials": "object", "basicAuthCredentials.password": "string", "basicAuthCredentials.username": "string", "connectionSettings": "object", "connectionSettings.connectionTimeout": "integer", "connectionSettings.encryptionType": "string", "connectionSettings.host": "string", "connectionSettings.port": "integer", "enabled": "boolean", "googleMailCredentials": "object", "googleMailCredentials.authentications": "array", "googleMailCredentials.clientId": "string", "googleMailCredentials.clientSecret": "string", "graphApiCredentials": "object", "graphApiCredentials.clientId": "string", "graphApiCredentials.clientSecret": "string", "graphApiCredentials.tenantId": "string", "senderSettings": "object", "senderSettings.displayName": "string", "senderSettings.emailAddress": "string"})
				if serr != nil {
					return serr
				}
