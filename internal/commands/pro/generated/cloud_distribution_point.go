...
// NewCloudDistributionPointCmd creates the cloud-distribution-point command group
func NewCloudDistributionPointCmd(ctx *registry.CLIContext) *cobra.Command {
	cmd := &cobra.Command{
		Use:         "cloud-distribution-point",
		Short:       "Manage cloud-distribution-point",
		Long:        `Manage cloud-distribution-point in Jamf Pro.`,
...
func newCloudDistributionPointCreateCmd(ctx *registry.CLIContext) *cobra.Command {
  ...
  jamf-cli pro cloud-distribution-point create --scaffold

  # Create a cloud-distribution-point from JSON
  echo '{"name":"Example"}' | jamf-cli pro cloud-distribution-point create`,
...
func newCloudDistributionPointDeleteCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagYes    bool
		flagDryRun bool
	)
  ...
  jamf-cli pro cloud-distribution-point delete

  # Delete without confirmation prompt
  jamf-cli pro cloud-distribution-point delete --yes`,
...
func newCloudDistributionPointHistoryCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
  ...
  jamf-cli pro cloud-distribution-point history`,
		Annotations: map[string]string{"jamf:privileges": "Read Cloud Distribution Point", "jamf:api": "pro", "jamf:gateway-privileges": "cloud-distribution-point:read"},
		RunE: func(cmd *cobra.Command, args []string) error {
			reqCtx := cmd.Context()
...
func newCloudDistributionPointPatchCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagScaffold bool
		flagSet      []string
		fromFile     string
...
func newCloudDistributionPointActionCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagFileName string
		flagType     string
	)
...
func newCloudDistributionPointFilesCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagPage     int
		flagPageSize int
		flagSort     []string
...
func newCloudDistributionPointRefreshInventoryCmd(ctx *registry.CLIContext) *cobra.Command {
	var (
		flagFileName string
	)
...
func newCloudDistributionPointTestConnectionCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
...
func newCloudDistributionPointUploadCapabilityCmd(ctx *registry.CLIContext) *cobra.Command {
	var ()
