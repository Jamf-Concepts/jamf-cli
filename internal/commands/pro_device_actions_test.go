...
func TestComputerActionSubcommands_Exist(t *testing.T) {
	...
	wantComputer := []string{
		...
		"settings", "set-auto-admin-password",
		"flush-commands",
	}
...
func TestMobileActionSubcommands_Exist(t *testing.T) {
	...
	wantMobile := []string{
		...
		"settings", "request-mirroring", "stop-mirroring",
		"refresh-cellular-plans", "apply-redemption-code",
		"delete-user", "log-out-user", "unlock-user-account",
		"flush-commands",
	}
