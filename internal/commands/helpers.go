...
func FetchAllPaginated(ctx context.Context, client generated.HTTPClient, basePath string, pageSize int) ([]map[string]interface{}, error) {
	if pageSize <= 0 {
		pageSize = 100
	}
...
func FetchClassicList(ctx context.Context, client generated.HTTPClient, path, wrapperKey string) ([]interface{}, error) {
	resp, err := client.Do(ctx, "GET", path, nil)
	if err != nil {
		return nil, err
	}
