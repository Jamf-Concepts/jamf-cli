...
func newConfigSetReportDirCmd() *cobra.Command {
	return &cobra.Command{
		...
		Short: "Set the directory HTML reports are written to",
		Long: `Set the directory where HTML reports generated by 'mcp serve' are written.

The directory is created if it does not exist. This setting applies to all
profiles — it is a global config key, not per-profile.
