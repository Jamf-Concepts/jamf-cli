...
// --set) — matching internal/security's hand-duplicated twin and the Pro
// generated --set parser's setNestedValue.
//
// The permissive version discarded the existing value: --set scope.owner=alice
// over a body whose scope is the string "team-a" replaced it with
// {"owner":"alice"}, which is a data-loss edit reported as success. apply is
// the newest and most consequential caller — its input is a whole desired
// state — which is why the divergence stopped being tolerable.
