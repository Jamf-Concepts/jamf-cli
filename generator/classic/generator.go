...
const CodegenHeader = "// Code generated by jamfpro-cli generator (classic). DO NOT EDIT."
...
{{- if hasOp .Operations "delete" }}
	"net/http"
{{- end }}
{{- if or (hasOp .Operations "get") (hasOp .Operations "update") (hasOp .Operations "delete") }}
	"net/url"
{{- end }}
{{- if needsOS . }}
	"os"
